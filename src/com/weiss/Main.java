...
public class Main {
    public static ArrayList<Upgrader> pointGenerators = new ArrayList<>();
    public static ArrayList<Upgrader> clickUpgraders = new ArrayList<>();
    ...
    public static int tick() { //Gets passive point gain and adds to total
        int addedPoints = pointGenerators.stream().mapToInt(pointGenerator -> pointGenerator.getCount() * pointGenerator.getPoints()).sum(); //Gets passive points gained
